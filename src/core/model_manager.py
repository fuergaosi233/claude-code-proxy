...
class ModelManager:
    ...
    def map_claude_model_to_openai(self, claude_model: str) -> str:
        ...
        if (
            ...
            or claude_model.startswith("o1-")
            or self.is_o3_model(claude_model)
        ):
            return claude_model
    ...
    def is_o3_model(self, model: str) -> bool:
        """Check if the model is an o3 model that requires special handling"""
